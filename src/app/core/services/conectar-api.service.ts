...
export class ConectarApiService {
  ...
  obtenerBlogCategorias() {
    const headers = new HttpHeaders({ Autorizacion: this.autorizacion });
    return this.clienteHttp.get(this.API + '/blog_categorias.php', { headers });
  }
  obtenerBlog() {
    const headers = new HttpHeaders({ Autorizacion: this.autorizacion });
  ...
  obtenerNoticiasPrincipal(id: any): Observable<any> {
    const headers = new HttpHeaders({ Autorizacion: this.autorizacion });
    return this.clienteHttp.get(this.API + '/noticias.php?id=' + id, {
      headers,
    });
  }
  ...
  obtenerContinuadaId(id: number): Observable<any> {
    const headers = new HttpHeaders({ Autorizacion: this.autorizacion });
    return this.clienteHttp.get(this.API + '/continuada.php?id=' + id, {
      headers,
    });
  }
  ...
  obtenerEmprendimientoId(id: number): Observable<any> {
    const headers = new HttpHeaders({ Autorizacion: this.autorizacion });
    return this.clienteHttp.get(this.API + '/emprendimientos.php?id=' + id, {
      headers,
    });
  }
  ...
  obtenerBienestarConvenios(): Observable<any> {
    const headers = new HttpHeaders({ Autorizacion: this.autorizacion });
    return this.clienteHttp.get(this.API + '/bienestar_convenios.php', {
      headers,
    });
  }
  ...
  obtenerProgramaId(id: number): Observable<any> {
    const headers = new HttpHeaders({ Autorizacion: this.autorizacion });
    return this.clienteHttp.get(this.API + '/programa.php?id=' + id, {
      headers,
    });
  }
  ...
  obtenerDesempenateId(id: number): Observable<any> {
    ...
    return this.clienteHttp.get(
      this.API + '/programa_desempenate.php?id=' + id,
      { headers },
    );
  }
  ...
  obtenerCalidadCrecimiento(): Observable<any> {
    const headers = new HttpHeaders({ Autorizacion: this.autorizacion });
    return this.clienteHttp.get(this.API + '/calidad_crecimiento.php', {
      headers,
    });
  }
  ...
  obtenercategoriasReglamentos(): Observable<any> {
    const headers = new HttpHeaders({ Autorizacion: this.autorizacion });
    return this.clienteHttp.get(this.API + '/categorias_reglamentos.php', {
      headers,
    });
  }
  obtenerReglamentos(id: number): Observable<any> {
    const headers = new HttpHeaders({ Autorizacion: this.autorizacion });
    return this.clienteHttp.get(this.API + '/reglamentos.php?id=' + id, {
      headers,
    });
  }
  ...
  obtenerHorarioProximo(id: number): Observable<any> {
    const headers = new HttpHeaders({ Autorizacion: this.autorizacion });
    return this.clienteHttp.get(this.API + '/horarios.php?id=' + id, {
      headers,
    });
  }
  ...
  insertarClienteExpou(cliente: any): Observable<any> {
    ...
    // return this.clienteHttp.post(this.API+ '/agregarDatos.php',{headers});
    return this.clienteHttp.post(
      this.API + '/agregarDatosExpoU.php',
      JSON.stringify(cliente),
      { headers },
    );
  }
  ...
  insertarClienteContinuada(cliente: any): Observable<any> {
    const headers = new HttpHeaders({ Autorizacion: this.autorizacion });
    return this.clienteHttp.post(
      this.API + '/agregarDatosContinuada.php',
      JSON.stringify(cliente),
      { headers },
    );
  }
  ...
  verificarClienteContinuada(cliente: any): Observable<any> {
    const headers = new HttpHeaders({ Autorizacion: this.autorizacion });
    return this.clienteHttp.post(
      this.API + '/verificarDatosContinuada.php',
      JSON.stringify(cliente),
      { headers },
    );
  }
  ...
  verificarEgresado(id: any): Observable<any> {
    const headers = new HttpHeaders({ Autorizacion: this.autorizacion });
    return this.clienteHttp.get(this.API + '/egresados.php?id=' + id, {
      headers,
    });
  }
  ...
  verificarRegistro(id: any): Observable<any> {
    const headers = new HttpHeaders({ Autorizacion: this.autorizacion });
    return this.clienteHttp.get(
      this.API + '/egresados.php?id_credencial=' + id,
      { headers },
    );
  }
  ...
  cifras(id: number): Observable<any> {
    const headers = new HttpHeaders({ Autorizacion: this.autorizacion });
    return this.clienteHttp.get(this.API + '/cifras.php?id=' + id, { headers });
  }
