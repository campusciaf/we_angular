...
export class OndashboardComponent {
  ...
  private buildEntrevista() {
    this.myEntrevista = this.fb.group({
      ...
      salud_mental: ['', Validators.required],
      condicion_especial: ['', Validators.required],
      nombre_condicion_especial: [''], // No required aquí
      estres_reciente: ['', Validators.required],
      desea_apoyo_mental: ['', Validators.required],
      costea_estudios: ['', Validators.required],
      labora_actualmente: ['', Validators.required],
      donde_labora: [''],
      tiempo_laborando: [''],
      desea_beca: ['', Validators.required],
      responsabilidades_familiares: ['', Validators.required],
      seguridad_carrera: ['', Validators.required],
      penso_abandonar: ['', Validators.required],
      desea_referir: ['', Validators.required],
      rendimiento_prev: ['', Validators.required],
      necesita_apoyo_academico: ['', Validators.required],
      nombre_materia: [''],
      tiene_habilidades_organizativas: ['', Validators.required],
      comodidad_herramientas_digitales: ['', Validators.required],
      acceso_internet: ['', Validators.required],
      acceso_computador: ['', Validators.required],
