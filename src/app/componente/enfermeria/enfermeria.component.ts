...
export class EnfermeriaComponent implements OnInit {
  ...
  listarSemestres1 = [{ semestre: 1 }, { semestre: 2 }, { semestre: 3 }];

  listarMaterias = [
    { semestre: 1, materia: 'TIC I' },
    {
      semestre: 1,
      materia: 'Prevenir y controlar infecciones en las personas y su entorno',
    },
    {
      semestre: 1,
      materia: 'Habilidades de la comunicación y técnicas de estudio',
    },
    ...
    {
      semestre: 1,
      materia: 'Admisión y orientación al usuario en el sistema de Salud',
    },
    ...
    {
      semestre: 2,
      materia: 'Cuidados medicoquirúrgicos (Asistencia básica al usuario)',
    },
    {
      semestre: 2,
      materia: 'Preparación, adminsitración y registro de medicamentos',
    },
  ...
  listarContacto = [
    ...
    },
    {
      ...
      pic: this.te_asesoro,
      link: 'https://api.whatsapp.com/send?phone=573143400100&amp;text=Mensaje%20desde%20enfermeria%20web',
      detalle: '',
      boton: 'Escribeme',
    },
    {
