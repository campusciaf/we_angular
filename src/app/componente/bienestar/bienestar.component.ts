...
export class BienestarComponent implements OnInit, OnDestroy {
  ...
  imagenesExperiencias: Array<any> = [
    {
      imagen: this.pic1,
      titulo: 'Equilibrio para lograr tus sueños',
      link: 'https://drive.google.com/drive/folders/1oND30Hhz7LTjH-L9WXaP5PZy6MaXKFz5?usp=drive_link',
    },
    {
      imagen: this.pic2,
      titulo: 'Guía creativa contra la depresión',
      link: 'https://drive.google.com/drive/folders/18POK6y9X1AIiJatEiOo6eCsJtOlOrIPJ?usp=drive_link',
    },
    {
      imagen: this.pic3,
      titulo: 'Tips creativos para controlar la ansiedad',
      link: 'https://drive.google.com/drive/folders/1eRdbd9rdPImor6peVYmU2JKUjaHEB7W8?usp=drive_link',
    },
    {
      imagen: this.pic4,
      titulo: 'Pon límites aprendiendo a priorizarte',
      link: 'https://drive.google.com/drive/folders/1DcZ1MW3R0GnzHOVhidvJCT5RZNc2d85p?usp=drive_link',
    },
    {
      imagen: this.pic5,
      titulo:
        'Mente clara, emociones equilibradas: Gestiona tu bienestar emocional',
      link: 'https://drive.google.com/drive/folders/1dfp46G6RvbpCSACrnfu3Mko6nzlkKMv6?usp=drive_link',
    },
  ];

  public bienestar_pc = 'assets/bienestar/bienestar.webp';
  public bienestar_m = 'assets/bienestar/bienestar.webp';
  ...
  readonly seccionesPrograma: { id: string; nav: string; label: string }[] = [
    ...
    {
      id: 'programa-de-permanencia',
      nav: '2',
      label: 'Programas de permanencia',
    },
    ...
    {
      id: 'promocion-socioeconomica',
      nav: '8',
      label: 'Promocion Socioeconomica',
    },
